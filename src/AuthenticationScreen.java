...
public class AuthenticationScreen extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel label_slu_logo = new JLabel();
        JLabel label_group6 = new JLabel();
        JLabel label_members = new JLabel();
        JLabel label_javier = new JLabel();
        JLabel label_miguel = new JLabel();
        JLabel label_natividad = new JLabel();
        JLabel label_tadeo = new JLabel();
        JPanel panel5 = new JPanel();
        JLabel label_login_label = new JLabel();
        JLabel label_register_label = new JLabel();
        JButton menu_button_register = new JButton();
        JButton menu_login_button = new JButton();
        ...
        //======== TitlePanel ========
        {
            ...
            TitlePanelLayout.setHorizontalGroup(TitlePanelLayout.createParallelGroup().addGroup(TitlePanelLayout.createSequentialGroup().addContainerGap().addComponent(menu_title, GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE).addContainerGap()));
            TitlePanelLayout.setVerticalGroup(TitlePanelLayout.createParallelGroup().addComponent(menu_title));
        }
        ...
        //======== MembersPanel ========
        {
            ...
            //---- label_slu_logo ----
            label_slu_logo.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/Saint_Louis_University_(Baguio)_logo.jpg"))));
            ...
            MembersPanelLayout.setHorizontalGroup(MembersPanelLayout.createParallelGroup().addGroup(MembersPanelLayout.createSequentialGroup().addContainerGap(32, Short.MAX_VALUE).addGroup(MembersPanelLayout.createParallelGroup().addGroup(MembersPanelLayout.createSequentialGroup().addGap(19, 19, 19).addComponent(label_javier, GroupLayout.PREFERRED_SIZE, 187, GroupLayout.PREFERRED_SIZE)).addComponent(label_natividad, GroupLayout.PREFERRED_SIZE, 205, GroupLayout.PREFERRED_SIZE)).addGap(29, 29, 29).addGroup(MembersPanelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(label_miguel, GroupLayout.PREFERRED_SIZE, 187, GroupLayout.PREFERRED_SIZE).addComponent(label_tadeo, GroupLayout.PREFERRED_SIZE, 187, GroupLayout.PREFERRED_SIZE)).addGap(31, 31, 31)).addGroup(MembersPanelLayout.createSequentialGroup().addGap(93, 93, 93).addComponent(label_slu_logo).addGroup(MembersPanelLayout.createParallelGroup().addGroup(MembersPanelLayout.createSequentialGroup().addGap(32, 32, 32).addComponent(label_members, GroupLayout.PREFERRED_SIZE, 149, GroupLayout.PREFERRED_SIZE)).addGroup(MembersPanelLayout.createSequentialGroup().addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(label_group6))).addContainerGap(148, Short.MAX_VALUE)));
            MembersPanelLayout.setVerticalGroup(MembersPanelLayout.createParallelGroup().addGroup(GroupLayout.Alignment.TRAILING, MembersPanelLayout.createSequentialGroup().addGroup(MembersPanelLayout.createParallelGroup().addGroup(MembersPanelLayout.createSequentialGroup().addContainerGap().addComponent(label_slu_logo)).addGroup(MembersPanelLayout.createSequentialGroup().addGap(21, 21, 21).addComponent(label_group6, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18).addComponent(label_members))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 11, Short.MAX_VALUE).addGroup(MembersPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(label_javier).addComponent(label_miguel)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(MembersPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(label_natividad).addComponent(label_tadeo)).addGap(20, 20, 20)));
        }
        ...
        //======== panel5 ========
        {
            ...
            panel5Layout.setHorizontalGroup(panel5Layout.createParallelGroup().addGroup(GroupLayout.Alignment.TRAILING, panel5Layout.createSequentialGroup().addGap(32, 32, 32).addGroup(panel5Layout.createParallelGroup().addComponent(label_login_label).addComponent(menu_login_button, GroupLayout.PREFERRED_SIZE, 139, GroupLayout.PREFERRED_SIZE)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 130, Short.MAX_VALUE).addGroup(panel5Layout.createParallelGroup().addComponent(menu_button_register, GroupLayout.PREFERRED_SIZE, 128, GroupLayout.PREFERRED_SIZE).addComponent(label_register_label)).addGap(53, 53, 53)));
            panel5Layout.setVerticalGroup(panel5Layout.createParallelGroup().addGroup(panel5Layout.createSequentialGroup().addContainerGap().addGroup(panel5Layout.createParallelGroup().addGroup(panel5Layout.createSequentialGroup().addComponent(label_login_label).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(menu_login_button)).addGroup(panel5Layout.createSequentialGroup().addComponent(label_register_label).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(menu_button_register))).addGap(0, 7, Short.MAX_VALUE)));
        }

        GroupLayout layout = new GroupLayout(this);
        setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup().addComponent(membersPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(panel5, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(titlePanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
        layout.setVerticalGroup(layout.createParallelGroup().addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addComponent(titlePanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addGap(33, 33, 33).addComponent(membersPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(panel5, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));

        //======== login_form ========
        {
            login_form.setBackground(Color.white);
            login_form.setResizable(false);
            login_form.setIconImage(new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/Saint_Louis_University_(Baguio)_logo.jpg"))).getImage());
            ...
            //======== panel4 ========
            {
                ...
                panel4Layout.setHorizontalGroup(panel4Layout.createParallelGroup().addGroup(panel4Layout.createSequentialGroup().addGap(18, 18, 18).addGroup(panel4Layout.createParallelGroup().addGroup(panel4Layout.createSequentialGroup().addGap(6, 6, 6).addGroup(panel4Layout.createParallelGroup().addGroup(GroupLayout.Alignment.TRAILING, panel4Layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(label_username).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(login_warning_username).addContainerGap(269, Short.MAX_VALUE)).addGroup(GroupLayout.Alignment.TRAILING, panel4Layout.createSequentialGroup().addGroup(panel4Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(GroupLayout.Alignment.LEADING, panel4Layout.createSequentialGroup().addComponent(label13).addGap(18, 18, 18).addComponent(login_warning_password).addGap(0, 235, Short.MAX_VALUE)).addComponent(login_password_field, GroupLayout.Alignment.LEADING).addComponent(login_username_field, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 322, Short.MAX_VALUE).addComponent(loginButton, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 322, Short.MAX_VALUE)).addGap(32, 32, 32)))).addGroup(panel4Layout.createSequentialGroup().addComponent(label_login_title).addContainerGap(300, Short.MAX_VALUE)))));
                panel4Layout.setVerticalGroup(panel4Layout.createParallelGroup().addGroup(panel4Layout.createSequentialGroup().addGap(15, 15, 15).addComponent(label_login_title).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panel4Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(label_username).addComponent(login_warning_username)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(login_username_field, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panel4Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(label13).addComponent(login_warning_password)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(login_password_field, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(loginButton, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE).addContainerGap(61, Short.MAX_VALUE)));
            }
            ...
            login_formContentPaneLayout.setHorizontalGroup(login_formContentPaneLayout.createParallelGroup().addComponent(panel4, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
            login_formContentPaneLayout.setVerticalGroup(login_formContentPaneLayout.createParallelGroup().addGroup(GroupLayout.Alignment.TRAILING, login_formContentPaneLayout.createSequentialGroup().addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(panel4, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addContainerGap()));
            login_form.pack();
        ...
        //======== dialogLoginSuccess ========
        {
            ...
            //======== panel6 ========
            {
                ...
                panel6Layout.setHorizontalGroup(panel6Layout.createParallelGroup().addComponent(login_label_account_name, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE).addComponent(label14, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE).addComponent(label15, GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE));
                panel6Layout.setVerticalGroup(panel6Layout.createParallelGroup().addGroup(panel6Layout.createSequentialGroup().addContainerGap().addComponent(label14).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(label15).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(login_label_account_name).addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
            }
            ...
            dialogLoginSuccessContentPaneLayout.setHorizontalGroup(dialogLoginSuccessContentPaneLayout.createParallelGroup().addComponent(panel6, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
            dialogLoginSuccessContentPaneLayout.setVerticalGroup(dialogLoginSuccessContentPaneLayout.createParallelGroup().addGroup(dialogLoginSuccessContentPaneLayout.createSequentialGroup().addComponent(panel6, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addContainerGap()));
        ...
        //======== registration_form ========
        {
            ...
            registration_form.setIconImage(new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/Saint_Louis_University_(Baguio)_logo.jpg"))).getImage());
            ...
            //======== panel7 ========
            {
                ...
                panel7Layout.setHorizontalGroup(panel7Layout.createParallelGroup().addGroup(panel7Layout.createSequentialGroup().addGap(18, 18, 18).addGroup(panel7Layout.createParallelGroup().addGroup(panel7Layout.createSequentialGroup().addComponent(label_register).addContainerGap()).addGroup(panel7Layout.createSequentialGroup().addGap(6, 6, 6).addGroup(panel7Layout.createParallelGroup().addGroup(panel7Layout.createSequentialGroup().addComponent(register_title_account_name).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(register_warning_account_name).addGap(0, 0, Short.MAX_VALUE)).addGroup(GroupLayout.Alignment.TRAILING, panel7Layout.createSequentialGroup().addGroup(panel7Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(register_password_field, GroupLayout.Alignment.LEADING).addComponent(register_account_name, GroupLayout.Alignment.LEADING).addComponent(register_username_field, GroupLayout.Alignment.LEADING).addGroup(panel7Layout.createSequentialGroup().addGap(6, 6, 6).addComponent(loginButton2, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addGroup(GroupLayout.Alignment.LEADING, panel7Layout.createSequentialGroup().addGroup(panel7Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(GroupLayout.Alignment.LEADING, panel7Layout.createSequentialGroup().addComponent(label17).addGap(43, 43, 43).addComponent(register_warning_password)).addGroup(GroupLayout.Alignment.LEADING, panel7Layout.createSequentialGroup().addComponent(label18).addGap(46, 46, 46).addComponent(register_warning_password_confirm)).addComponent(register_password_confirm_field, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 322, GroupLayout.PREFERRED_SIZE)).addGap(0, 0, Short.MAX_VALUE))).addGap(32, 32, 32)).addGroup(panel7Layout.createSequentialGroup().addComponent(register_label_username).addGap(39, 39, 39).addComponent(register_warning_username).addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))));
                panel7Layout.setVerticalGroup(panel7Layout.createParallelGroup().addGroup(panel7Layout.createSequentialGroup().addGap(15, 15, 15).addComponent(label_register).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panel7Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(register_title_account_name).addComponent(register_warning_account_name)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(register_account_name, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panel7Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(register_label_username).addComponent(register_warning_username)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(register_username_field, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panel7Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(label17).addComponent(register_warning_password)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(register_password_field, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(panel7Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(label18).addComponent(register_warning_password_confirm)).addGap(6, 6, 6).addComponent(register_password_confirm_field, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(loginButton2, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE).addContainerGap(78, Short.MAX_VALUE)));
            }
            ...
            registration_formContentPaneLayout.setHorizontalGroup(registration_formContentPaneLayout.createParallelGroup().addComponent(panel7, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
            registration_formContentPaneLayout.setVerticalGroup(registration_formContentPaneLayout.createParallelGroup().addGroup(registration_formContentPaneLayout.createSequentialGroup().addComponent(panel7, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addGap(0, 0, Short.MAX_VALUE)));
        ...
        //======== dialogRegistrationSuccess ========
        {
            ...
            //======== panel8 ========
            {
                ...
                panel8Layout.setHorizontalGroup(panel8Layout.createParallelGroup().addComponent(register_label_account_name, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE).addComponent(label19, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE).addComponent(label20, GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE));
                panel8Layout.setVerticalGroup(panel8Layout.createParallelGroup().addGroup(panel8Layout.createSequentialGroup().addContainerGap().addComponent(label19).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(label20).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(register_label_account_name).addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
            }
            ...
            dialogRegistrationSuccessContentPaneLayout.setHorizontalGroup(dialogRegistrationSuccessContentPaneLayout.createParallelGroup().addComponent(panel8, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
            dialogRegistrationSuccessContentPaneLayout.setVerticalGroup(dialogRegistrationSuccessContentPaneLayout.createParallelGroup().addGroup(dialogRegistrationSuccessContentPaneLayout.createSequentialGroup().addComponent(panel8, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addContainerGap()));
